...
TRAIN_SPEC = os.path.join(FILE_BASE, 'boiler_eta_train.csv')
TEST_SPEC = os.path.join(FILE_BASE, 'boiler_eta_test.csv')

TRAIN_DATA_FILE = os.path.join(FILE_BASE, "df_train_eta.pickle")
TEST_DATA_FILE = os.path.join(FILE_BASE, "df_test_eta.pickle")
...
def gen_test_spec():
    ...
    fault_list += loader.get_fault_list(1,  {'eta_fault': 0.0  }, context='bc == 0')
    fault_list += loader.get_fault_list(6,  {'eta_fault': 1.0  }, context='bc == 0 & eta_f_final <= 0.5')
    fault_list += loader.get_fault_list(3,  {'eta_fault': 1.0  }, context='bc == 0 & eta_f_final > 0.5')
