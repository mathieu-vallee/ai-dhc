within AI_DHC.Components.Storage.BaseClass;
model ThermalConductor
  "Lumped thermal element transporting heat without storing it"
  extends Modelica.Thermal.HeatTransfer.Interfaces.Element1D;
  Modelica.Units.SI.ThermalConductance G = G_ext "Thermal conductance of material from outside model";

  Modelica.Blocks.Interfaces.RealInput G_ext annotation (Placement(transformation(extent={{120,46},{80,86}})));
equation
  Q_flow = G*dT;
  annotation (
