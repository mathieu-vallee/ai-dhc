...
model InnerCycle_HeatPump "Blackbox model of refrigerant cycle of a heat pump"
  extends AI_DHC.Components.HeatPump.BaseClasses.PartialInnerCycle;
...
equation
  ...
  connect(PerformanceDataHPHeating.QCon, switchQCon.u1)
    annotation (Line(points={{10.4,19.2},{10.4,-4},{68,-4}}, color={0,0,127}));
  connect(PerformanceDataHPHeating.Pel, switchPel.u1) annotation (Line(
        points={{32,19.2},{32,-30},{8,-30},{8,-68}}, color={0,0,127}));
  ...
  connect(PerformanceDataHPCooling.QCon, gainCon.u) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(PerformanceDataHPHeating.QEva, gainEva.u) annotation (Line(points={{53.6,19.2},{53.6,-6},{-51.2,-6}},
                                             color={0,0,127}));
  ...
  connect(sigBus, PerformanceDataHPHeating.sigBus) annotation (Line(
      points={{0,102},{0,86},{32.27,86},{32.27,79.12}},
      color={255,204,51},
      thickness=0.5));
