...
expandable connector VapourCompressionMachineControlBus "Standard data bus with heat pump or chiller information"
extends Modelica.Icons.SignalBus;
  // Setpoints
  Real COP_modifier "Fault on COP (between 0 and 1)";
