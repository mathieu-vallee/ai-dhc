within AI_DHC.Components.HeatPump;
model HeatPump "Grey-box model for reversible heat pumps using a black-box to simulate the refrigeration cycle"


  extends AI_DHC.Components.HeatPump.BaseClasses.PartialReversibleVapourCompressionMachine(
    use_rev=true,
    final machineType=true,
    redeclare AI_DHC.Components.HeatPump.BaseClasses.InnerCycle_HeatPump innerCycle(
  ...
  replaceable model PerDataMainHP =
      AI_DHC.Database.HeatPump.PerformanceData.BaseClasses.PartialPerformanceData
